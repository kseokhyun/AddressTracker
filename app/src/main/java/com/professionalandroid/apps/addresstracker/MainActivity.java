package com.professionalandroid.apps.addresstracker;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShowLocationButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View arg0) {
                ...
                Toast.makeText(MainActivity.this, "Current \nLatitude " + latitude + "\nLongititue " + longitude, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        builder.setTitle("Location Service denied");
        builder.setMessage("You need Location Service.\n"
                + "Clike to change your setting");
            ...
            case GPS_ENABLE_REQUEST_CODE:
                if (checkLocationServicesStatus()) {
                    if (checkLocationServicesStatus()) {
                        ...
                        Log.d("@@@", "onActivityResult : On activity");
                        checkRunTimePermission();
                        return;
                    }
                }
